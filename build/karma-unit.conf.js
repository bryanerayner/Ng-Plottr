module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: 'vendor/angular-bootstrap/ui-bootstrap-tpls.min.js', included: false},
      {pattern: 'vendor/angular-ui-router/release/angular-ui-router.min.js', included: false},
      {pattern: 'vendor/angular-ui-utils/ui-utils.min.js', included: false},
      {pattern: 'vendor/angular-moment/angular-moment.min.js', included: false},
      {pattern: 'vendor/restangular/dist/restangular.min.js', included: false},
      {pattern: 'vendor/ng-table/ng-table.js', included: false},
      {pattern: 'vendor/lodash/dist/lodash.min.js', included: false},
      {pattern: 'vendor/moment/min/moment.min.js', included: false},
